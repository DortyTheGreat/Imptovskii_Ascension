...
HUD'u полнейший пиздец

import com.example.addon.modules.ProximaRender.TotemParticle;
import com.example.addon.modules.ProximaRender.hud.CrystalStatsHud;
import com.example.addon.modules.ProximaRender.hud.CrystalStreakHud;
*/
...
public class CrystalBoomer extends Module {
    ...
    private final Vec3d vec3d = new Vec3d();
    int tick;
    ...
    private void onRender2D(Render2DEvent event) {
        ...
        if (renderPos != null) {
            vec3d.set(renderPos.getX() + 0.5, renderPos.getY() + 0.5, renderPos.getZ() + 0.5);
