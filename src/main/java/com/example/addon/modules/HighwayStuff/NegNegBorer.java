package com.example.addon.modules.HighwayStuff;
...
import com.example.addon.modules.HighwayStuff.BorerModule;

public class NegNegBorer extends BorerModule {
    public NegNegBorer() {
        super("NegNegBorer", "Automatically digs -X -Z highway.", 1, 2, -2, -2);
    }
